...
export const meta = {
  ...
  description: "前端 yarn workspaces 应用",
  date: "2021-08-05"
};
...
<p style={{ textAlign: "center", fontSize: 24 }}>Yarn Workspaces</p>

![](/static/images/yarn_workspaces.png)

<p style={{ textAlign: "center", fontSize: 12, color: "" }}>
