...
export interface WebpackOptions {
   ...
   * 向编译器添加其他插件.
   * webpack-cli 会在数组的最前面插入 CLIPlugin 的实例
   */
  plugins?: Plugins;
  /**
...
![webpack config](/static/images/webpack.config.png)
...
[webpack loader](/blog/webpack/loaders)

[webpack option.Optimization](/blog/webpack/options-Optimization)
...
[webpack plugin](/blog/webpack/plugins)
