...
export const meta = {
  ...
  description:
    "javascript instanceof 原理, instanceof 运算符用于检测构造函数的 prototype 属性是否出现在某个实例对象的原型链上。",
  date: "2022-10-26",
  cover: RandomCover[2]
};
...
一个简单的实现， 如有考虑不完善的地方请帮忙指出进行完善[issues](https://github.com/freeshineit/freeshineit.github.io/issues)， 谢谢 🙏
